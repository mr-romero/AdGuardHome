...
<p align="center">
  ...
  <a href="https://github.com/mr-romero/AdGuardHome/wiki">Wiki</a> |
  <a href="https://reddit.com/r/Adguard">Reddit</a> |
  <a href="https://twitter.com/AdGuard">Twitter</a> |
  <a href="https://t.me/adguard_en">Telegram</a>
  <br/><br/>
  <a href="https://codecov.io/github/mr-romero/AdGuardHome?branch=master">
    <img src="https://img.shields.io/codecov/c/github/mr-romero/AdGuardHome/master.svg" alt="Code Coverage"/>
  </a>
  <a href="https://goreportcard.com/report/mr-romero/AdGuardHome">
    <img src="https://goreportcard.com/badge/github.com/mr-romero/AdGuardHome" alt="Go Report Card"/>
  </a>
  <a href="https://hub.docker.com/r/adguard/adguardhome">
    <img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/adguard/adguardhome.svg?maxAge=604800"/>
  </a>
  <br/>
  <a href="https://github.com/mr-romero/AdGuardHome/releases">
    <img src="https://img.shields.io/github/release/mr-romero/AdGuardHome/all.svg" alt="Latest release"/>
  </a>
...
```sh
curl -s -S -L https://raw.githubusercontent.com/mr-romero/AdGuardHome/master/scripts/install.sh | sh -s -- -v
```

To install with `wget` run the following command:

```sh
wget --no-verbose -O - https://raw.githubusercontent.com/mr-romero/AdGuardHome/master/scripts/install.sh | sh -s -- -v
```

To install with `fetch` run the following command:

```sh
fetch -o - https://raw.githubusercontent.com/mr-romero/AdGuardHome/master/scripts/install.sh | sh -s -- -v
```
...
[wiki]: https://github.com/mr-romero/AdGuardHome/wiki
...
[openapi]:  https://github.com/mr-romero/AdGuardHome/tree/master/openapi
...
[issue-1228]:  https://github.com/mr-romero/AdGuardHome/issues/1228
...
```sh
git clone https://github.com/mr-romero/AdGuardHome
cd AdGuardHome
make
```
...
[src-makefile]: https://github.com/mr-romero/AdGuardHome/blob/master/Makefile
[targ-docker]:  https://github.com/mr-romero/AdGuardHome/tree/master/scripts#build-dockersh-build-a-multi-architecture-docker-image
[targ-release]: https://github.com/mr-romero/AdGuardHome/tree/master/scripts#build-releasesh-build-a-release-for-all-platforms
...
[guide]: https://github.com/mr-romero/CodeGuidelines/
[pr]:    https://github.com/mr-romero/AdGuardHome/pulls
...
3. Standalone builds. Use the automated installation script or look for the available builds [on the Wiki][wiki-platf].
   ...
   ```sh
   curl -s -S -L https://raw.githubusercontent.com/mr-romero/AdGuardHome/master/scripts/install.sh | sh -s -- -c beta
   ```

   Script to install an edge version:

   ```sh
   curl -s -S -L https://raw.githubusercontent.com/mr-romero/AdGuardHome/master/scripts/install.sh | sh -s -- -c edge
   ```

[wiki-platf]: https://github.com/mr-romero/AdGuardHome/wiki/Platforms
...
[iss]: https://github.com/mr-romero/AdGuardHome/issues
...
[iss-help]: https://github.com/mr-romero/AdGuardHome/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22
...
- [Go](https://golang.org/dl/) and its libraries:
    ...
    - [dnsproxy](https://github.com/mr-romero/dnsproxy)
    - [urlfilter](https://github.com/mr-romero/urlfilter)
...
[src-packagejson]: https://github.com/mr-romero/AdGuardHome/blob/master/client/package.json
